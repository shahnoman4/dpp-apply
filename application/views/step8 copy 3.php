<div class="row">
	<form id="step8-form" action="<?=site_url('apply/process/'.$current_step)?>" method="post" style="width: 100%">
		<div class="col-12">
			<?php if (!$preschool) : ?>
			...
			<fieldset style="width:100%;">
				...
				<table class="table table-striped table-hover" style="width:100%;">
					<tr class="edit-tr">
						<th style="width:33%">
							...
							<a href="<?=site_url('apply/step/1/yes')?>" class="edit-link">Edit</a>
						</th>
					...
					<tr  class="edit-tr">
						...
						<td>
							Annual Income: <?= $this->meta->find('income'); ?><br>
							Household: <?= $this->meta->find('total_household'); ?><br>
					...
					<tr class="edit-tr">
						<th>
							...
							<a href="<?=site_url('apply/step/2')?>" class="edit-link">Edit</a>
						</th>
						<td>
							...
							<?= $this->lang->line('child_applicant_address'); ?>: <?=$this->meta->find('applicant_address'); ?><br>
							<?= $this->lang->line('child_applicant_who'); ?>: <?=$this->meta->find('relation_to_child'); ?>
						</td>
					</tr>
					<tr class="edit-tr">
						<th>
						<?= $this->lang->line('parent_full_name'); ?>
							<a href="<?=site_url('apply/step/3')?>" class="edit-link">Edit</a>
						</th>
						<td>
							...
							<?= $this->lang->line('dpp_send_messages'); ?> <?=$this->meta->find('parent_1_dpp_send_messages'); ?><br>
							...
							<? if ( $this->meta->find('parent_2_email') ) : ?>
								<?= $this->lang->line('email'); ?>: <?= $this->meta->find('parent_2_email'); ?><br>
							<? endif; ?>
							<? if ( $this->meta->find('parent_2_dpp_send_messages') ) : ?>
					...
					<tr class="edit-tr">
						<th>
							...
							<a href="<?=site_url('apply/step/4')?>" class="edit-link">Edit</a>
						</th>
						<td>
							<?= $this->lang->line('child_race'); ?>: <?= implode( ', ', $this->meta->find('child_race', array()) ); ?><br>
							<?= $this->lang->line('home_language'); ?>: <?=$this->meta->find('primary_language');?><br>
							<?= $this->lang->line('home_language'); ?>: <?= implode( ', ', $this->meta->find('home_language', array()) ); ?>
						</td>
					</tr>
					<tr class="edit-tr">
						<th>
						...
						<td>
							<?= $this->lang->line('ccap'); ?>: <?=$this->meta->find('participate_ccap'); ?><br>
							<?= $this->lang->line('head_start'); ?>: <?=$this->meta->find('participate_head_start'); ?><br>
							<?= $this->lang->line('cpp'); ?>: <?=$this->meta->find('participate_cpp'); ?>
						</td>
					</tr>
					<tr class="edit-tr">
						<th>
							<?= $this->lang->line('provide_income'); ?>
							<a href="<?=site_url('apply/step/5')?>" class="edit-link">Edit</a>
						</th>
						<td>
							<?=$this->meta->find('disclose_income'); ?>
							<?php if ( 'yes' == $this->meta->find('disclose_income') ) : ?>
								<br>
								Total Income: $<?= number_format( $this->meta->find('all_income_total', 0), 2 ); ?>
							<?php endif; ?>
						</td>
					</tr>
					<tr class="edit-tr">
						<th>
							...
							<a href="<?=site_url('apply/step/7')?>" class="edit-link">Edit</a>
						</th>
						<td>
							<?=$this->meta->find('hear_dpp');?><br><?= $this->meta->find('hear_dppother_text') ?>
						</td>
					</tr>
					<tr class="edit-tr">
						<th>
						...
						<td>
							<?=$this->meta->find('use_dpp_resources');?>
						</td>
					</tr>
				</table>
				...
				<div class="form-group">
					...
					<div class="form-check">
						<input type="checkbox" class="form-check-input" name="child_race[]" id="child_race_1" value="american_indian_alaskan" autocomplete="off" <?= in_array('american_indian_alaskan', $this->meta->find('child_race', array())) ? 'checked="checked"' : '' ?>>
						<label class="form-check-label" for="child_race_1">
							&nbsp;<?= $this->lang->line('american_indian_alaskan'); ?>
						</label>
					</div>
					<div class="form-check">
						<input type="checkbox" class="form-check-input" name="child_race[]" id="child_race_2" value="black" autocomplete="off" <?= in_array('black', $this->meta->find('child_race', array())) ? 'checked="checked"' : '' ?>>
						<label class="form-check-label" for="child_race_2">
							&nbsp;<?= $this->lang->line('black'); ?>
						</label>
					</div>
					<div class="form-check">
						<input type="checkbox" class="form-check-input" name="child_race[]" id="child_race_3" value="asian" autocomplete="off" <?= in_array('asian', $this->meta->find('child_race', array())) ? 'checked="checked"' : '' ?>>
						<label class="form-check-label" for="child_race_3">
							&nbsp;<?= $this->lang->line('asian'); ?>
						</label>
					</div>
					<div class="form-check">
						<input type="checkbox" class="form-check-input" name="child_race[]" id="child_race_4" value="hispanic" autocomplete="off" <?= in_array('hispanic', $this->meta->find('child_race', array())) ? 'checked="checked"' : '' ?>>
						<label class="form-check-label" for="child_race_4">
							&nbsp;<?= $this->lang->line('hispanic'); ?>
						</label>
					</div>
					<div class="form-check">
						<input type="checkbox" class="form-check-input" name="child_race[]" id="child_race_5" value="white" autocomplete="off" <?= in_array('white', $this->meta->find('child_race', array())) ? 'checked="checked"' : '' ?>>
						<label class="form-check-label" for="child_race_5">
							&nbsp;<?= $this->lang->line('white'); ?>
						</label>
					</div>
					<div class="form-check">
						<input type="checkbox" class="form-check-input" name="child_race[]" id="child_race_6" value="other" autocomplete="off" <?= in_array('other', $this->meta->find('child_race', array())) ? 'checked="checked"' : '' ?>>
